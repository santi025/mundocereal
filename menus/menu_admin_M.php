    ...
    <style>
        * {
        ...
        .container {
            display: flex;
            height: 100vh;
            flex-direction: row-reverse; /* Mueve el menú a la derecha */
        }
        ...
        .list__item {
            ...
            width: 100%;
            text-align: center;
            height: 53px; /* Aumentado para que los elementos sean más grandes */
            padding-top: 10px;
            line-height: 1; /* Ajusta el interlineado de los elementos dentro de la lista */
            font-size: 1.2em; /* Aumenta el tamaño de la fuente de los elementos */
        }
        ...
        .list__link {
            ...
            transition: opacity 0.3s ease;
            font-weight: 600;
            line-height: 1; /* Ajusta el interlineado de los enlaces dentro de los elementos de lista */
        }
